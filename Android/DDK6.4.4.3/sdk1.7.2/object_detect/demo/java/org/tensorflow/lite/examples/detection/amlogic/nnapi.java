...
*   Date: 2019.9
=========================================================================*/
package org.tensorflow.lite.examples.detection.amlogic;
...
public class nnapi {
	...
	public float[] nn_model_outputs_get(float[] outbuf,int netid,int format)
	{
		float[] out;
		out = model_outputs_get(this.context,outbuf,netid,format);
		return out;
	}
	...
	private native float[] model_outputs_get(long context,float[] outbuf,int netid,int format);
